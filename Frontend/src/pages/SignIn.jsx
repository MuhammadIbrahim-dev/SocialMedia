    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-md animate-[fadeIn_0.5s_ease-out] rounded-2xl bg-white p-8 text-center shadow-lg sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <button type="submit" className="transform rounded-lg bg-indigo-600 py-3 text-lg font-semibold text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-indigo-700 active:translate-y-0">Sign In</button>
        </form>
